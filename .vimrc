...
" }}}
" Ameen's custom mappings -------------------------------------------------{{{

" Shift + j to insert 2 new lines and start typing on the first
inoremap <C-j> <CR><Esc>O

" [named function] Ctrl + fn to insert 'function () {}' and start typing before the ()
inoremap <C-f><C-n> function<space>()<space>{}<Esc>4hi

" [anonymous function] Ctrl + fu to insert 'function () {}' and start typing inside the ()
inoremap <C-f><C-u> function<space>()<space>{}<Esc>3hi

" }}}
" Ameen's custom vim ------------------------------------------------------{{{

" required to have airline display by default
set laststatus=2
